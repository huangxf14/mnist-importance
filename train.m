function [hiddenWeights, outputWeights, error, sample_error] = train(activationFunction, dActivationFunction, numberOfHiddenUnits, hiddenWeights, outputWeights, inputValues, targetValues,  epochs, batchSize, learningRate)
